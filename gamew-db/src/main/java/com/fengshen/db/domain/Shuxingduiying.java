...
public class Shuxingduiying implements Cloneable, Serializable
{
    ...
    public void setYingwen(final String yingwen) {
    ...
    public String toString() {
        ...
        sb.append(", IS_DELETED=").append(Shuxingduiying.IS_DELETED);
        sb.append(", NOT_DELETED=").append(Shuxingduiying.NOT_DELETED);
    ...
    public boolean equals(final Object that) {
        ...
        final Shuxingduiying other = (Shuxingduiying)that;
        if (this.getId() == null) {
            if (other.getId() != null) {
                return false;
            }
