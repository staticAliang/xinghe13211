...
public class Skilljineng implements Cloneable, Serializable
{
    ...
    public void setSkillMp(final Integer skillMp) {
    ...
    public String toString() {
        ...
        sb.append(", IS_DELETED=").append(Skilljineng.IS_DELETED);
        sb.append(", NOT_DELETED=").append(Skilljineng.NOT_DELETED);
    ...
    public boolean equals(final Object that) {
        ...
        final Skilljineng other = (Skilljineng)that;
        if (this.getId() == null) {
            if (other.getId() != null) {
                return false;
            }
