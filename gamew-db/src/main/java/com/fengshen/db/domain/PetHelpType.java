...
public class PetHelpType implements Cloneable, Serializable
{
    ...
    public void setPolar(final Integer polar) {
        this.polar = polar;
    }
    ...
    public String toString() {
        ...
        sb.append(", IS_DELETED=").append(PetHelpType.IS_DELETED);
        sb.append(", NOT_DELETED=").append(PetHelpType.NOT_DELETED);
    ...
    public boolean equals(final Object that) {
        ...
        final PetHelpType other = (PetHelpType)that;
        if (this.getId() == null) {
            if (other.getId() != null) {
                return false;
            }
