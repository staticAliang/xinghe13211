...
public class MedicineShop implements Cloneable, Serializable
{
    ...
    public String toString() {
        ...
        sb.append(", IS_DELETED=").append(MedicineShop.IS_DELETED);
        sb.append(", NOT_DELETED=").append(MedicineShop.NOT_DELETED);
    ...
    public boolean equals(final Object that) {
        ...
        final MedicineShop other = (MedicineShop)that;
        if (this.getId() == null) {
            if (other.getId() != null) {
                return false;
            }
