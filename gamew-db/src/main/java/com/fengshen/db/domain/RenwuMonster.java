...
public class RenwuMonster implements Cloneable, Serializable
{
    ...
    public String toString() {
        ...
        sb.append(", IS_DELETED=").append(RenwuMonster.IS_DELETED);
        sb.append(", NOT_DELETED=").append(RenwuMonster.NOT_DELETED);
    ...
    public boolean equals(final Object that) {
        ...
        final RenwuMonster other = (RenwuMonster)that;
        if (this.getId() == null) {
            if (other.getId() != null) {
                return false;
            }
	...
	public RenwuMonster(String mapName, Integer type) {
		this.mapName = mapName;
		this.type = type;
	}
	
	public RenwuMonster(Integer type) {
		this.type = type;
	}
	
	public RenwuMonster(String mapName) {
		this.mapName = mapName;
	}
