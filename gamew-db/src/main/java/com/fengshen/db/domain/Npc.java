...
public class Npc implements Cloneable, Serializable {
	...
	public String toString() {
		...
		sb.append(", IS_DELETED=").append(Npc.IS_DELETED);
		sb.append(", NOT_DELETED=").append(Npc.NOT_DELETED);
	...
	public enum Column {
		id("id", "id", "INTEGER", false), icon("icon", "icon", "INTEGER", false), x("x", "x", "INTEGER", false),
		y("y", "y", "INTEGER", false), name("name", "name", "VARCHAR", true),
		mapId("map_id", "mapId", "INTEGER", false), addTime("add_time", "addTime", "TIMESTAMP", false),
		updateTime("update_time", "updateTime", "TIMESTAMP", false), deleted("deleted", "deleted", "BIT", false);
		...
		private Column(final String column, final String javaProperty, final String jdbcType,
				final boolean isColumnNameDelimited) {
			this.column = column;
	...
	public Npc(Integer id, String name, Integer x, Integer y, Integer mapId, Integer icon) {
		this.id = id;
		this.x = x;
		this.y = y;
		this.name = name;
