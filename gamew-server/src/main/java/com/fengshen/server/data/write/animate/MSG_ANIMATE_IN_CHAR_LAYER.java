 ...
 *
 */
public class MSG_ANIMATE_IN_CHAR_LAYER extends BaseWrite<Vo_ANIMATE_IN_CHAR> {
	...
	protected void writeO(ByteBuf buff, Vo_ANIMATE_IN_CHAR object) {
		...
		GameWriteTool.writeInt(buff, object.getX());
		GameWriteTool.writeInt(buff, object.getY());
