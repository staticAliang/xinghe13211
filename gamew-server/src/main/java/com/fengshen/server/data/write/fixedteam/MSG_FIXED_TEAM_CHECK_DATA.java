...
public class MSG_FIXED_TEAM_CHECK_DATA extends BaseWrite<Vo_FIXED_TEAM_CHECK_DATA> {

	@Override
	protected void writeO(ByteBuf buff, Vo_FIXED_TEAM_CHECK_DATA object) {
		
		GameWriteTool.writeByte(buff, object.getAction());
		GameWriteTool.writeString(buff, object.getTeanName());
		...
		for(Member m:object.getMembers()) {
			...
			GameWriteTool.writeByte(buff, m.getHasConfirm());
		}
	}
