 ...
 *
 */
public class FightWuSeGuangHuan extends FightRoundSkill {
	...
	public List<FightResult> doSkill(FightContainer fightContainer, FightRequest fightRequest, JiNeng jiNeng) {
		...
		for (FightObject fightObject2 : targetList) {
			...
			vo_19959_0.round = fightContainer.round;
			vo_19959_0.aid = fightObject2.fid;
			vo_19959_0.action = 43;
			vo_19959_0.vid = fightObject2.fid;
			vo_19959_0.para = 0;
			// MSG_C_ACTION
			FightManager.send(fightContainer, new MSG_C_ACTION(), vo_19959_0);

			fightObject2.getBuffState().add(0);
			fightObject2.getBuffState().add(8);
			this.skillLevel = jiNeng.skill_level;
			fightObject2.updateState(fightContainer,0,8);
			
			
			FightWuSeGuangHuan that = new FightWuSeGuangHuan();
