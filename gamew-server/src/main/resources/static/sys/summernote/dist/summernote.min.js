...
default:
    ...
    var e = function() {
        ...
        return e.prototype.render = function(e) {
            var o = t(this.markup);
            if (this.options && this.options.contents && o.html(this.options.contents), this.options && this.options.className && o.addClass(this.options.className), this.options && this.options.data && t.each(this.options.data,
            function(t, e) {
                o.attr("data-" + t, e)
    ...
    o = function(o, n) {
        return function() {
            ...
            return i && i.children && (r = i.children),
            new e(o, r, i, n)
        }
    },
    ...
    h = o('<ul class="dropdown-menu" role="list">',
    function(e, o) {
    ...
    p = o('<ul class="dropdown-menu note-check" role="list">',
    function(e, o) {
        var n = t.isArray(o.items) ? o.items.map(function(t) {
            var e = "string" == typeof t ? t: t.value || "",
            n = o.template ? o.template(t) : t;
    ...
    f = o('<div class="note-color-palette"/>',
    function(t, e) {
        for (var o = [], n = 0, i = e.colors.length; n < i; n++) {
            for (var r = e.eventName,
            s = e.colors[n], a = e.colorsName[n], l = [], c = 0, d = s.length; c < d; c++) {
                var u = s[c],
                h = a[c];
    ...
    m = o('<div class="modal" aria-hidden="false" tabindex="-1" role="dialog"/>',
    function(t, e) {
    ...
    g = o(['<div class="note-popover popover in">', '  <div class="arrow"/>', '  <div class="popover-content note-children-container"/>', "</div>"].join(""),
    function(t, e) {
        var o = void 0 !== e.direction ? e.direction: "bottom";
        t.addClass(o),
        e.hideArrow && t.find(".arrow").hide()
    }),
    v = o('<div class="checkbox"></div>',
    function(t, e) {
    ...
    y = {
        ...
        options: {},
        button: function(t, e) {
            return o('<button type="button" class="note-btn btn btn-default btn-sm" role="button" tabindex="-1">',
            function(t, e) {
                e && e.tooltip && t.attr({
                    title: e.tooltip,
    ...
    var N = {
        ...
        all: function(t, e) {
            for (var o = 0,
            n = t.length; o < n; o++) if (!e(t[o])) return ! 1;
            return ! 0
        },
        sum: function(t, e) {
            return e = e || C.self,
        ...
        clusterBy: function(t, e) {
            return t.length ? S(t).reduce(function(t, o) {
                var n = x(t);
                return e(x(n), o) ? n[n.length] = o: t[t.length] = [o],
                t
            },
            [[w(t)]]) : []
        },
    ...
    if (P) {
        ...
        L && (A = parseFloat(L[1])),
        (L = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/.exec(R)) && (A = parseFloat(L[1]))
    }
    var H = /Edge\/\d+/.test(R),
    D = !!window.CodeMirror;
    ...
    var Nt = {
        ...
        listDescendant: function(t, e) {
            ...
            function n(i) {
                t !== i && e(i) && o.push(i);
                for (var r = 0,
                s = i.childNodes.length; r < s; r++) n(i.childNodes[r])
            } (t),
            o
        },
        ...
        fromOffsetPath: function(t, e) {
            for (var o = t,
            n = 0,
            i = e.length; n < i; n++) o = o.childNodes.length <= e[n] ? o.childNodes[o.childNodes.length - 1] : o.childNodes[e[n]];
            return o
        },
        splitTree: xt,
    ...
    function Rt(t, e) {
        ...
        if (0 !== o && Nt.isText(s[o - 1])) {
            ...
            l = l.nextSibling;
            l.nodeValue;
            e && l.nextSibling && Nt.isText(l.nextSibling) && d === l.nodeValue.length && (d -= l.nodeValue.length, l = l.nextSibling),
            i = l,
            o = d
        }
        return {
    ...
    function Pt(t) {
        ...
        n = e(t.node, t.offset);
        return o.moveToElementText(n.node),
    ...
    var Lt = function() {
        ...
        e.prototype.scrollIntoView = function(e) {
            var o = t(e).height();
            return e.scrollTop + o < this.sc.offsetTop && (e.scrollTop += Math.abs(e.scrollTop + o - this.sc.offsetTop)),
            this
        },
        ...
        e.prototype.splitText = function() {
            ...
            Nt.isText(this.sc) && !Nt.isEdgePoint(this.getStartPoint()) && (o.sc = this.sc.splitText(this.so), o.so = 0, t && (o.ec = o.sc, o.eo = this.eo - this.so)),
        ...
        e.prototype.deleteContents = function() {
            ...
            i = Nt.prevPointUntil(o.getStartPoint(),
            function(t) {
        ...
        e.prototype.wrapBodyInlineWithPara = function() {
            if (Nt.isBodyContainer(this.sc) && Nt.isEmpty(this.sc)) return this.sc.innerHTML = Nt.emptyPara,
        ...
        e.prototype.getWordRange = function(t) {
            ...
            var n = Nt.prevPointUntil(o,
            function(t) {
                return ! Nt.isCharPoint(t)
            });
            return t && (o = Nt.nextPointUntil(o,
            function(t) {
                return ! Nt.isCharPoint(t)
            })),
    ...
    Ht = {
        ...
        createFromNode: function(t) {
            ...
            n = t,
            i = Nt.nodeLength(n);
            return Nt.isVoid(e) && (o = Nt.listPrev(e).length - 1, e = e.parentNode),
    ...
    var Dt = function() {
        ...
        t.prototype.applySnapshot = function(t) {
            ...
            null !== t.bookmark && Ht.createFromBookmark(this.editable, t.bookmark).select()
        },
    ...
    Ft = function() {
        ...
        e.prototype.current = function(e) {
            ...
            return n.anchor = e.isOnAnchor() && Nt.ancestor(e.sc, Nt.isAnchor),
    ...
    Bt = function() {
        ...
        e.prototype.indent = function(e) {
            ...
            function(e, n) {
                var i = N.head(n);
                Nt.isLi(i) ? o.wrapList(n, i.parentNode.nodeName) : t.each(n,
                function(e, o) {
                    t(o).css("marginLeft",
                    function(t, e) {
        ...
        e.prototype.outdent = function(e) {
            ...
            function(e, n) {
                var i = N.head(n);
                Nt.isLi(i) ? o.releaseList([n]) : t.each(n,
                function(e, o) {
                    t(o).css("marginLeft",
                    function(t, e) {
        ...
        e.prototype.releaseList = function(e, o) {
            ...
            function(e, i) {
                ...
                i = o ? Nt.listDescendant(c, Nt.isLi) : N.from(c.childNodes).filter(Nt.isLi),
                !o && Nt.isList(a.parentNode) || (i = i.map(function(t) {
                    return Nt.replace(t, "P")
                })),
                t.each(N.from(i).reverse(),
                function(t, e) {
                    Nt.insertAfter(e, a)
                });
    ...
    zt = function() {
        ...
        return e.prototype.insertTab = function(t, e) {
            var o = Nt.createText(new Array(e + 1).join(Nt.NBSP_CHAR)); (t = t.deleteContents()).insertNode(o, !0),
        ...
        e.prototype.insertParagraph = function(e) {
            ...
            if (i) {
                ...
                if (Nt.isEmpty(i) && Nt.isPara(i) && Nt.isBlockquote(i.parentNode)) Nt.insertAfter(i, i.parentNode),
                n = i;
                else {
    ...
    Mt = function(t, e, o, n) {
        ...
        function() {
            for (var t = n.rows,
            e = 0; e < t.length; e++) for (var o = t[e].cells, i = 0; i < o.length; i++) c(t[e], o[i])
        } ()
    };
    Mt.where = {
        Row: 0,
    ...
    var Ot, Ut = function() {
            ...
            for (var r = new Mt(n, Mt.where.Column, Mt.requestAction.Add, t(i).closest("table")[0]).getActionList(), s = 0; s < r.length; s++) {
                ...
                case Mt.resultAction.SumSpanCount:
                    if ("right" === o) {
                        ...
                        c++,
                        a.baseCell.setAttribute("colSpan", c)
        ...
        e.prototype.createTable = function(e, o, n) {
            ...
            return n && n.tableClassName && d.addClass(n.tableClassName),
            d[0]
        },
    ...
    jt = function() {
        function e(e) {
            ...
            this.createLink = this.wrapCommand(function(e) {
                ...
                n = o.options.onCreateLink ? o.options.onCreateLink(n) : /^[A-Za-z][A-Za-z0-9+-.]*\:[\/\/]?/.test(n) ? n: "http://" + n;
                var l = [];
                if (a) {
            ...
            this.removeMedia = this.wrapCommand(function() {
                ...
                e.parent("figure").length ? e.parent("figure").remove() : e = t(o.restoreTarget()).detach(),
        ...
        return e.prototype.initialize = function() {
            ...
            this.options.airMode || (this.options.width && this.$editor.outerWidth(this.options.width), this.options.height && this.$editable.outerHeight(this.options.height), this.options.maxHeight && this.$editable.css("max-height", this.options.maxHeight), this.options.minHeight && this.$editable.css("min-height", this.options.minHeight)),
        ...
        e.prototype.preventDefaultEditableShortCuts = function(t) { (t.ctrlKey || t.metaKey) && N.contains([66, 73, 85], t.keyCode) && t.preventDefault()
        },
        e.prototype.isLimited = function(t, e) {
            return t = t || 0,
            (void 0 === e || !(At.isMove(e.keyCode) || e.ctrlKey || e.metaKey || N.contains([At.code.BACKSPACE, At.code.DELETE], e.keyCode))) && (this.options.maxTextLength > 0 && this.$editable.text().length + t >= this.options.maxTextLength)
        },
        e.prototype.createRange = function() {
            return this.focus(),
            Ht.create(this.editable)
        },
        ...
        e.prototype.getSelectedText = function() {
            var t = this.createRange();
            return t.isOnAnchor() && (t = Ht.createFromNode(Nt.ancestor(t.sc, Nt.isAnchor))),
            t.toString()
        },
        ...
        e.prototype.unlink = function() {
            var t = this.createRange();
            if (t.isOnAnchor()) {
                var e = Nt.ancestor(t.sc, Nt.isAnchor); (t = Ht.createFromNode(e)).select(),
                this.beforeCommand(),
        ...
        e.prototype.getLinkInfo = function() {
            ...
            return o.length && (n.isNewWindow = "_blank" === o.attr("target")),
            n
        },
    ...
    Kt = function() {
        function e(e) {
            ...
            this.$dropzone = t(['<div class="note-dropzone">', '  <div class="note-dropzone-message"/>', "</div>"].join("")).prependTo(this.$editor)
        }
        return e.prototype.initialize = function() {
        ...
        e.prototype.attachDragAndDropEvent = function() {
            ...
            this.documentEventHandlers.onDragenter = function(t) {
                ...
                i || o.length || !r || (e.$editor.addClass("dragover"), e.$dropzone.width(e.$editor.width()), e.$dropzone.height(e.$editor.height()), n.text(e.lang.image.dragImageHere)),
                o = o.add(t.target)
            },
            this.documentEventHandlers.onDragleave = function(t) { (o = o.not(t.target)).length || e.$editor.removeClass("dragover")
            },
            ...
            function(o) {
                ...
                o.preventDefault(),
                n && n.files && n.files.length ? (e.$editable.focus(), e.context.invoke("editor.insertImagesOrCallback", n.files)) : t.each(n.types,
                function(o, i) {
                    var r = n.getData(i);
    ...
    z.hasCodeMirror && (z.isSupportAmd ? require(["codemirror"],
    function(t) {
        Ot = t
    ...
    Wt = function() {
        ...
        return e.prototype.initialize = function() {
            var t = this;
            this.options.airMode || this.options.disableResizeEditor ? this.destroy() : this.$statusbar.on("mousedown",
            function(e) {
                e.preventDefault(),
                e.stopPropagation();
                ...
                n = function(e) {
                    ...
                    n = t.options.minheight > 0 ? Math.max(n, t.options.minheight) : n,
                    n = t.options.maxHeight > 0 ? Math.min(n, t.options.maxHeight) : n,
                    t.$editable.height(n)
                };
                t.$document.on("mousemove", n).one("mouseup",
                function() {
    ...
    Gt = function() {
        ...
        e.prototype.toggle = function() {
            ...
            this.isFullscreen() ? (this.$editable.data("orgHeight", this.$editable.css("height")), this.$window.on("resize", this.onResize).trigger("resize"), this.$scrollbar.css("overflow", "hidden")) : (this.$window.off("resize", this.onResize), this.resizeTo({
        ...
        return e.prototype.initialize = function() {
            ...
            function(t) {
                if (Nt.isControlSizing(t.target)) {
                    ...
                    e.$document.on("mousemove", r).one("mouseup",
                    function(t) {
                        t.preventDefault(),
    ...
    Xt = function() {
        ...
        e.prototype.addToolbarButtons = function() {
            ...
            function() {
                ...
                return t.each(o["font-family"].split(","),
                function(o, n) {
                    n = n.trim().replace(/['"]+/g, ""),
                    e.isFontDeservedToAdd(n) && -1 === t.inArray(n, e.options.fontNames) && e.options.fontNames.push(n)
                }),
            ...
            function() {
                return e.ui.buttonGroup({
                    ...
                    children: [e.button({
                        ...
                        callback: function(t) {
                            t.find(".note-recent-color").css("background-color", "#FFFF00"),
        ...
        e.prototype.tableMoveHandler = function(e) {
            ...
            r.data("value", c + "x" + d),
            c > 3 && c < this.options.insertTableMaxSize.col && a.css({
                width: c + 1 + "em"
            }),
    ...
    ne = function() {
        ...
        e.prototype.show = function() {
            ...
            this.showImageDialog().then(function(e) {
                ...
                t.context.invoke("editor.restoreRange"),
                "string" == typeof e ? t.context.invoke("editor.insertImage", e) : t.context.invoke("editor.insertImagesOrCallback", e)
            }).fail(function() {
                t.context.invoke("editor.restoreRange")
            })
        },
        e.prototype.showImageDialog = function() {
            ...
            return t.Deferred(function(t) {
                ...
                e.ui.onDialogShown(e.$dialog,
                function() {
                    e.context.triggerEvent("dialog.shown"),
                    o.replaceWith(o.clone().on("change",
                    function(e) {
    ...
    se = function() {
        ...
        e.prototype.createVideoNode = function(e) {
            ...
            return o.addClass("note-video-clip"),
            o[0]
        },
        e.prototype.show = function() {
            var t = this,
    ...
    ce = function() {
        ...
        e.prototype.createItemTemplates = function(e, o) {
            ...
            return o.map(function(o, i) {
                ...
                return r.append(n.template ? n.template(o) : o + ""),
                r.data({
                    index: e,
                    item: o
                }),
        ...
        e.prototype.createGroup = function(e, o) {
            ...
            return this.searchKeyword(e, o,
            function(t) { (t = t || []).length && (i.html(n.createItemTemplates(e, t)), n.show())
            }),
            i
        },
        e.prototype.handleKeyup = function(t) {
    ...
    de = function() {
        ...
        e.prototype._initialize = function() {
            ...
            var n = t.extend({},
            this.options.modules, t.summernote.plugins || {});
        ...
        e.prototype.code = function(t) {
            ...
            if (void 0 === t) return this.invoke("codeview.sync"),
        ...
        e.prototype.initializeModule = function(t) {
            ...
            e.shouldInitialize() && (e.initialize && e.initialize(), e.events && Nt.attachEvents(this.$note, e.events))
        },
        ...
        e.prototype.removeModule = function(t) {
            var e = this.modules[t];
            e.shouldInitialize() && (e.events && Nt.detachEvents(this.$note, e.events), e.destroy && e.destroy()),
    ...
    t.fn.extend({
        summernote: function() {
            ...
            n = "object" === e,
            i = t.extend({},
            t.summernote.options, n ? N.head(arguments) : {});
            i.langInfo = t.extend(!0, {},
            t.summernote.lang["en-US"], t.summernote.lang[i.lang]),
            i.icons = t.extend(!0, {},
            t.summernote.options.icons, i.icons),
